...
def inference(input, circuit):
    ...
    out, remainder = DenseInt(200, 1, 10**18, out, circuit['dense_2_weights'], circuit['dense_2_bias'])
    output['dense_2_out'] = out
    output['dense_2_remainder'] = remainder

    out = ArgMaxInt(out)
    output['dense_2_softmax_out'] = out
